...
public class PlayerMovement : MonoBehaviour
{
    ...
    public void Buff(float _speedBuff, float _buffTime)
    {
        StartCoroutine(Buffing(_speedBuff, _buffTime));
    }

    private IEnumerator Buffing(float _speedBuff, float _buffTime)
    {
        speed += _speedBuff;
